    ...
    <body>
        ...
        <div class="well text-center">
            ...
            <div class="col-md-6">
                ...
                <button id="button" onclick="myFunction('<?php echo $one_item['Points']; ?>','<?php echo $one_item2['Points'];  ?>')"><?php echo $one_item['Performer'];  ?> has more points</button>
            </div>
            <
            <div class="col-md-6">
            ...
            <button id="button1" onclick="myFunction('<?php echo $one_item2['Points']; ?>','<?php echo $one_item['Points'];  ?>')"><?php echo $one_item2['Performer'];  ?> has more points</button>
